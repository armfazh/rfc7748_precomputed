...
void mul2_256x256_integer_x64(uint64_t *const c, uint64_t *const a, uint64_t *const b)
{
  ...
  __asm__ __volatile__(
    ...
    "addq  %%r8,  8(%0) ;"
    "adcq %%rax,  %%r9  ;"    "movq %%r9, 16(%0) ;" "movq $0, %%rax ;"
    "adcq %%r11, %%rbx  ;"
    "adcq %%r13, %%rcx  ;"
    "adcq %%rdx, %%rax  ;"
    ...
    "addq  %%r8, 16(%0) ;"
    "adcq %%rbx,  %%r9  ;"    "movq %%r9, 24(%0) ;" "movq $0, %%rbx ;"
    "adcq %%r11, %%rcx  ;"
    "adcq %%r13, %%rax  ;"
    "adcq %%rdx, %%rbx  ;"
    ...
    "addq  %%r8, 24(%0) ;"
    "adcq %%rcx,  %%r9  ;"    "movq %%r9,  32(%0) ;"   "movq $0, %%rcx ;"
    "adcq %%r11, %%rax  ;"    "movq %%rax, 40(%0) ;"
    "adcq %%r13, %%rbx  ;"    "movq %%rbx, 48(%0) ;"
    "adcq %%rdx, %%rcx  ;"    "movq %%rcx, 56(%0) ;"

    "movq 32(%1), %%rdx; " /* A[0] */
    "mulx 32(%2),  %%r8,  %%r9; " /* A[0]*B[0] */                           "movq %%r8, 64(%0) ;"
    "mulx 40(%2), %%r10, %%rax; " /* A[0]*B[1] */    "addq %%r10,  %%r9 ;"  "movq %%r9, 72(%0) ;"
    "mulx 48(%2), %%r12, %%rbx; " /* A[0]*B[2] */    "adcq %%r12, %%rax ;"
    "mulx 56(%2), %%r14, %%rcx; " /* A[0]*B[3] */    "adcq %%r14, %%rbx ;"
    /*******************************************/    "adcq    $0, %%rcx ;"

    "movq 40(%1), %%rdx; " /* A[1] */
    "mulx 32(%2),  %%r8,  %%r9; " /* A[1]*B[0] */
    "mulx 40(%2), %%r10, %%r11; " /* A[1]*B[1] */    "addq %%r10,  %%r9 ;"
    "mulx 48(%2), %%r12, %%r13; " /* A[1]*B[2] */    "adcq %%r12, %%r11 ;"
    "mulx 56(%2), %%r14, %%rdx; " /* A[1]*B[3] */    "adcq %%r14, %%r13 ;"
    /*******************************************/    "adcq    $0, %%rdx ;"

    "addq  %%r8, 72(%0) ;"
    "adcq %%rax,  %%r9  ;"    "movq %%r9, 80(%0) ;"    "movq $0, %%rax ;"
    "adcq %%r11, %%rbx  ;"
    "adcq %%r13, %%rcx  ;"
    "adcq %%rdx, %%rax  ;"
    ...
    "mulx 40(%2), %%r10, %%r11; " /* A[2]*B[1] */    "addq %%r10,  %%r9 ;"
    "mulx 48(%2), %%r12, %%r13; " /* A[2]*B[2] */    "adcq %%r12, %%r11 ;"
    "mulx 56(%2), %%r14, %%rdx; " /* A[2]*B[3] */    "adcq %%r14, %%r13 ;"
    /*******************************************/    "adcq    $0, %%rdx ;"

    "addq  %%r8, 80(%0) ;"
    "adcq %%rbx,  %%r9  ;"    "movq %%r9, 88(%0) ;"    "movq $0, %%rbx ;"
    "adcq %%r11, %%rcx  ;"
    "adcq %%r13, %%rax  ;"
    "adcq %%rdx, %%rbx  ;"
    ...
    "mulx 40(%2), %%r10, %%r11; " /* A[3]*B[1] */    "addq %%r10,  %%r9 ;"
    "mulx 48(%2), %%r12, %%r13; " /* A[3]*B[2] */    "adcq %%r12, %%r11 ;"
    "mulx 56(%2), %%r14, %%rdx; " /* A[3]*B[3] */    "adcq %%r14, %%r13 ;"
    /*******************************************/    "adcq    $0, %%rdx ;"

    "addq  %%r8, 88(%0) ;"
    "adcq %%rcx,  %%r9  ;"    "movq  %%r9,  96(%0) ;"   "movq $0, %%rcx ;"
