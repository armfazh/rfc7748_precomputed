...
{
	print_bytes(key,SIZE_ELEMENT_BYTES);
}

void random_X448_key(argKey key)
{
	random_bytes(key,SIZE_ELEMENT_BYTES);
}
...
const KeyGen X448_KeyGen_x64 = x448_keygen_x64;
const Shared X448_Shared_x64 = x448_shared_x64;
